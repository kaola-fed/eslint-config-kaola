...
module.exports = {
  ...
  "rules": {
    ...
    // @TODO: "semi-spacing": [2, {"before": false, "after": true}], // 该规则用来规定分号前后是否加空格，默认配置如下，分号后面加空格，前面不加空格
    // @TODO: "no-mixed-spaces-and-tabs": 2, //不允许空格和 tab 混用
    // @TODO: "indent": [2, 4, {
    //   // case 用一个缩进
    //   "SwitchCase": 1,
    //   // 变量声明用一个缩进
    ...
    // }], // 缩进设置为 4 个空格
    // @TODO: "no-multiple-empty-lines": [2, { "max": 2, "maxEOF": 1}], // 不要留超过规定数目的空白行
    // @TODO: "space-before-function-paren": ["error", "never"], // 禁止在 function 的左括号之前使用空格
    // @TODO: "space-in-parens": ["error", "never"], // 禁止在圆括号内使用空格, ( 左括号右边和右括号左边 )
    // @TODO: "quotes": [1, "single"], // 单引用
    "quote-props": [2, "as-needed"], // 当没有严格要求时，禁止对象字面量属性名称使用引号
    // @TODO: "array-bracket-spacing": [2, "never"], // 数组前后不能带空格
    // @TODO: "camelcase": 2, // 强制使用驼峰命名
    ...
    // @TODO: "comma-spacing": ["error", {"before": false, "after": true}], // 逗号前禁止有空格, 逗号后必须有空格
    "comma-style": ["error", "last"], // 禁止逗号前置
    // @TODO: "brace-style": ["error", "1tbs"], // 强制使用 1tbs 风格的代码块括号，见 http://eslint.cn/docs/rules/brace-style
    // @TODO: "func-call-spacing": ["error", "never"], // 禁止函数调用时括号左边有空格
    // @TODO: "key-spacing": ["error", {
    //   "beforeColon": false,
    //   "afterColon": true,
    //   "mode": "strict"
    ...
    // @TODO: "complexity": [1, 5], // 用来控制函数的复杂度，分支超过 5 时报错, if else 分支超 5 报错
    // @TODO: "default-case": 2, // 所有的 switch 语句都必须要有一个 default 分支
    "guard-for-in": 2,
    // 代码块的内容不能为空，禁止空代码块
    // if (foo) {
    // }
    ...
    // @TODO: "no-multi-spaces": 1, // 保证了在逻辑表达式、条件表达式、申明语句、数组元素、对象属性、sequences、函数参数中不使用超过一个的空白符
